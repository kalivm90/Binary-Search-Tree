...
exports.randomArray = exports.printTraversal = void 0;
const randomArray = (length = 15) => Array.from({
  "length": length
}, () => Math.floor(Math.random() * 100) + 1).sort((a, b) => a - b);
...
exports.printTraversal = printTraversal;